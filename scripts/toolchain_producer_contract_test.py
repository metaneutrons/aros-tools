...
class ToolchainProducerContractTests(unittest.TestCase):
    ...
    def test_diagnostic_reservation_and_partial_registration_are_exact(self) -> None:
        ...
        self.assertEqual(diagnostics["registration"], "M4-native-package-readback")
        self.assertEqual(diagnostics["registered_codes"], ["AX0101", "AX0102", "AX0201", "AX0202", "AX0301", "AX0302", "AX0401", "AX0501", "AX0502", "AX0503", "AX0601", "AX0602", "AX0801"])
        ...
        for code in diagnostics["codes"]:
            ...
            if code in diagnostics["registered_codes"]:
