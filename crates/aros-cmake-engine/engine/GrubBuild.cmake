...
function(aros_build_grub2)
    ...
    _aros_grub_real_path("${_AROS_GRUB_BUILD_MODULE_DIR}" _engine_root)
    ...
    set(_install_manifest_logical
        "${_AROS_GRUB_BUILD_MODULE_DIR}/${_install_manifest_relative}")
    ...
    set(_expected_install_manifest
        "${_engine_root}/${_install_manifest_relative}")
    _aros_grub_reject_symlink_components(
