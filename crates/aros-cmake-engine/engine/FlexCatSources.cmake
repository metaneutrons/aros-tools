...
function(_aros_flexcat_source_path out_var value label)
    ...
    if(IS_ABSOLUTE "${value}")
        ...
        set(_path "${AROS_SOURCE_DIR}/${value}")
    endif()
...
function(aros_declare_flexcat_header)
    ...
    if(IS_ABSOLUTE "${FCH_DIRECTORY}")
        ...
        set(_directory "${AROS_SOURCE_DIR}/${FCH_DIRECTORY}")
    endif()
    ...
    set(_runner "${AROS_CMAKE_ENGINE_DIR}/RunFlexCat.cmake")
    add_custom_command(
        OUTPUT "${_output}"
...
function(aros_declare_flexcat_sources)
    ...
    if(IS_ABSOLUTE "${FCS_DIRECTORY}")
        ...
        set(_directory "${AROS_SOURCE_DIR}/${FCS_DIRECTORY}")
    endif()
    cmake_path(NORMAL_PATH _directory)
    cmake_path(ABSOLUTE_PATH AROS_SOURCE_DIR NORMALIZE OUTPUT_VARIABLE _source_root)
