...
pub use lifecycle::{
    acquire_read_lease, acquire_write_lease, apply_removal, keep, keep_many, preview_removal,
    release, CacheLifecycleError, CacheObjectKind, CacheObjectLease, CacheObjectProof,
