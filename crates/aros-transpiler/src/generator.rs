...
mod tests {
    ...
    fn header_only_flexcat_owner_is_concrete_before_openurl() {
        ...
        assert!(cmake
            .contains("DESCRIPTION \"${CMAKE_SOURCE_DIR}/external/openurl/locale/OpenURL.pot\""));
        assert!(!cmake
            .contains("if(NOT TARGET \"external-openurl-prefs-setup\")\n    add_custom_target"));
    }
