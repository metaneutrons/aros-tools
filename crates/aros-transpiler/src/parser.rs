...
use crate::ast::{
    CopyDirectoryDecl, DefineHeaderDecl, GenmoduleLinklibs, MetaTargetRule, ModuleType,
    ParsedMmakefile, TargetDefinition,
};
use crate::capability::external_cmake;
...
use crate::make_vars::{
    collect_vars, collect_vars_impl, collect_vars_impl_with_forward_locals, directive_tail,
    evaluate_conditional, strip_make_comment, variable_assignment, ConditionalFrame,
